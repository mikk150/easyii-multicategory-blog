        ...
        [
            ...
            'buttons' => [
                'moveup' => function ($url, $model, $key) {
                    return Html::a('<span class="glyphicon glyphicon-arrow-up"></span>', ['up', 'id' => $model->primaryKey]);
                },
                'movedown' => function ($url, $model, $key) {
                    return Html::a('<span class="glyphicon glyphicon-arrow-down"></span>', [ 'down', 'id' => $model->primaryKey]);
                }
            ]
        ]
    ]
